        ...
        <>
            ...
            <div className='flex flex-col justify-items-start mx-5 gap-1 relative'>
                ...
                <div className='absolute top-3/5 right-5'>
                    {
                         passwordStatus ? (<FaEyeSlash size={20} className='hover:text-gray-900 transition-all cursor-pointer' onClick={controlPassword} />) :
                            (<FaEye size={20} className='hover:text-gray-900 transition-all cursor-pointer' onClick={controlPassword} />)
                    }
                </div>
            </div>
